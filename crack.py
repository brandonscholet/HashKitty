...
#command components
parser.add_argument("-r", "--rules", type=validate_file, nargs='?', const=True, default=None, help="Path to the dumped file.")
parser.add_argument("-u", "--user", action='store_true', default=False, help="Show user.")
parser.add_argument("-s", "--show", action='store_true', default=False, help="Show Results for file")
parser.add_argument("-q", "--quiet", action='store_true', default=False, help="Path to the dumped file.")
parser.add_argument("-w", "--wordlist", type=validate_file, default=None, help="wordlist")

#mode or auto mode. default is 1000
exclusive_group = parser.add_mutually_exclusive_group()
exclusive_group.add_argument("-m", "--mode", default="1000", help="set custom mode. Default is 1000")
exclusive_group.add_argument("-a", "--auto-mode",  action='store_true', default=False, help="Let it figure out the hash mode.")
